...
const entries: SitemapEntry[] = [
  ...
  { path: "/fiches-de-revision/droit", changefreq: "monthly", priority: "0.8" },
  { path: "/fiches-de-revision/marketing", changefreq: "monthly", priority: "0.8" },
  { path: "/fiches-de-revision/analyse-litteraire", changefreq: "monthly", priority: "0.8" },
