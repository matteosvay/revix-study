  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "press-down": "press-down 0.10s ease forwards",
        "shake-x": "shake-x 0.38s ease",
        "page-in": "page-in 0.28s cubic-bezier(0.22, 1, 0.36, 1)",
        "pop-in": "pop-in 0.40s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "bounce-soft": "bounce-soft 1.6s ease-in-out infinite",
        "slide-up-fade": "slide-up-fade 0.38s cubic-bezier(0.22, 1, 0.36, 1)",
      },
    },
  },
