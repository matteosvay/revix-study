-- Track how many quiz-bonus loot boxes the user has already claimed
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS quiz_loot_box_claimed_count integer NOT NULL DEFAULT 0;
...
BEGIN
  ...
  -- Generate rewards (mirrors daily loot box logic)
  ...
  IF v_cosmetic_roll < 90 THEN
    ...
    IF FOUND THEN
      INSERT INTO user_cosmetics(user_id, item_key, acquired_via) VALUES (v_user, v_cosmetic.item_key, 'quiz_bonus');
    ELSE
